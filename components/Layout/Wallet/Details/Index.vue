...
<template>
  <div class="flex items-center bg-blue-500 text-white font-semibold whitespace-nowrap rounded-lg">
    <BaseHoverMenu popper-class="min-w-[310px] sm:min-w-[356px] bg-gray-850 shadow-dropdown rounded-lg">
          ...
          <div class="rounded-lg bg-gray-1000">
            <div class="flex flex-col py-3 px-4">
              <div class="flex justify-between pb-2">
                ...
                <span class="text-blue-500 hover:text-opacity-80 cursor-pointer text-xs font-medium" @click="disconnect">
                  Disconnect
                </span>
              </div>
