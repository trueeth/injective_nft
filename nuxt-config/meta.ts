export const metaTags = {
    ...
    description:
        'Ninja NFT ponzi businuss built on injective network',
    keywords:
        'injective protocol, dapp, decentralized app, Ninja, NFT, cosmos, injective, ibc, cross-chain',
    author: 'InjectiveLabs',
    url: 'https://injectdegen.com',
    shortName: 'NINJA',
